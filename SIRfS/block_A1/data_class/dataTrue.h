...
public:
    ...
    DataTrue(const DataTrue& new_data)
    {
        this->inputImage = new_data.inputImage;
        this->im = new_data.im;
        this->log_im = new_data.log_im;
        this->mask = new_data.mask;
    }
    //operators overloading
    DataTrue& operator=(const DataTrue& new_data)
    {
        this->inputImage = new_data.inputImage;
        this->im = new_data.im;
        this->log_im = new_data.log_im;
