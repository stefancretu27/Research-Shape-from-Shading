...
void Lut::initializeLutHeightData()
{
    ...
    dFileReader.readVector("prior/height/MKZ/GSM/F_LL15.txt", this->F_LL, this->n_bins, 15);
    dFileReader.readVector("prior/height/MKZ/GSM/F_cost15.txt", this->F_cost, this->n_bins, 15);

    DataFile<unsigned int> uFileReader;
    uFileReader.readVector("prior/height/MKZ/GSM/N_train.txt", this->N_train, this->n_bins, 0);
}
...
void Lut::initializeLutReflectanceGrayData()
{
    ...
    //read data from files to vectors
    DataFile<double> dFileReader;
    dFileReader.readVector("prior/reflectance/gray/grayMA/GSM/F_LL15.txt", this->F_LL, this->n_bins, 15);
    dFileReader.readVector("prior/reflectance/gray/grayMA/GSM/F_cost15.txt", this->F_cost, this->n_bins, 15);

    DataFile<unsigned int> uFileReader;
    uFileReader.readVector("prior/reflectance/gray/grayMA/GSM/N_train.txt", this->N_train, this->n_bins, 0);
}
