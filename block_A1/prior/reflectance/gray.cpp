...
void ReflectanceGray::initializeReflectanceGrayData()
{
    ...
    dFileReader.readVector("block_A1/prior/reflectance/A_train15.txt", this->A_train, 300000, 15);
    dFileReader.readVector("block_A1/prior/reflectance/A_spline15.txt", this->A_spline, 256, 15);
}
